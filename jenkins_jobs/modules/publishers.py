...
def imagegallery(parser, xml_parent, data):
    ...
    """
    gallery_recorder = XML.SubElement(xml_parent, 'org.jenkinsci.plugins.imagegallery.ImageGalleryRecorder')
    galleries = XML.SubElement(gallery_recorder, 'imageGalleries')
    # FIXME: the plugin supports several galleries at once
    gallery = XML.SubElement(galleries, 'org.jenkinsci.plugins.imagegallery.imagegallery.ArchivedImagesGallery')
